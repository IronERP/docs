            ...
            <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
              ...
              <div className="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                  ...
                  <li>
                    <a href="/docs/intro" className="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Documentation</a>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
              ...
              <a href="/docs/intro" className="relative inline-block w-full p-px rounded-lg sm:w-auto group h-11 bg-gradient-to-r from-purple-600 to-sky-500 dark:from-purple-600 dark:to-blue-400 before:absolute before:inset-0 before:bg-gradient-to-r before:from-purple-400 before:to-sky-400 dark:before:from-purple-600 dark:before:to-sky-500 before:scale-75 before:opacity-50 before:rounded-md before:blur-lg before:transition before:duration-300 active:before:scale-90 focus:before:scale-90 focus:before:opacity-75 hover:before:scale-100 hover:before:opacity-100">
                <p className="relative flex justify-center h-full text-sm font-medium items-center text-white tracking-wide bg-gray-950 px-[calc(1.5rem-1px)] rounded-[calc(0.5rem-1px)] group-hover:bg-gray-900 transition duration-300">
                  Get Started Today
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-5 h-5 ms-2"><path stroke-linecap="round" stroke-linejoin="round" d="M17.25 8.25L21 12m0 0l-3.75 3.75M21 12H3"></path></svg>
                </p>
              </a>

              <a href="https://github.com/IronERP/IronERP" className="flex items-center justify-center px-6 mt-4 text-sm font-medium tracking-wide text-gray-700 capitalize transition-all duration-200 transform border border-gray-300 rounded-lg sm:mt-0 gap-x-2 h-11 dark:text-white hover:border-gray-400 dark:border-gray-700 dark:hover:border-gray-500 focus:ring focus:ring-blue-300 dark:focus:ring-white/10 focus:ring-opacity-80">
                <svg width="40" height="40" viewBox="0 0 24 24" fill="#343C54" xmlns="http://www.w3.org/2000/svg" className='w-5 h-5'>
            ...
            <div className="grid pt-8 text-left border-t border-gray-200 md:gap-16 dark:border-gray-700 md:grid-cols-2">
              <div>
                <div className="mb-10">
                  ...
                  <p className="text-gray-500 dark:text-gray-400">IronERP is a highly customizable, open-source ERP solution. The project is currently in a very early proof-of-concept stage and should absolutely not be used in production.</p>
                </div>
                <div className="mb-10">
                  <h3 className="flex items-center mb-4 text-lg font-medium text-gray-900 dark:text-white">
                    <svg className="flex-shrink-0 mr-2 w-5 h-5 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-8-3a1 1 0 00-.867.5 1 1 0 11-1.731-1A3 3 0 0113 8a3.001 3.001 0 01-2 2.83V11a1 1 0 11-2 0v-1a1 1 0 011-1 1 1 0 100-2zm0 8a1 1 0 100-2 1 1 0 000 2z" clip-rule="evenodd"></path></svg>
                  ...
                  <p className="text-gray-500 dark:text-gray-400">Currently, IronERP is an experimental project that I'm working on mainly for fun and not for profit. In the current stage, I'm not working on this project with the intention of making a profit but because I needed something complex to hone my skills on.</p>
                  <p className="text-gray-500 dark:text-gray-400">Should this project ever actually take off, I might consider asking for donations to cover my expenses so I can work on the project full time. (And possibly share with other contributors, should there be any).</p>
                  <p className="text-gray-500 dark:text-gray-400">On the off-chance that this turns into a real, production ready thing, I plan to finance its development by establishing a "consulting" company that will sell commercial support and potentially a SaaS offering.</p>
                  <p className="text-gray-500 dark:text-gray-400">The project will always remain 100% open-source with absolute 1:1 feature parity between the "Community" and potential "Commercial" releases.</p>
                </div>
              </div>
              <div>
              <div className="mb-10">
                  ...
                  <p className="text-gray-500 dark:text-gray-400"><strong>Absolutely!</strong> If you're new to IronERP, please look through issues labeled with Good First Issue and feel free to pick anything from there. When you do, please comment on the issue to let other contributors know somebody is working on the issue.</p>
                  <p className="text-gray-500 dark:text-gray-400">Please see <a href="https://github.com/IronERP/IronERP/blob/nightly/CONTRIBUTING.md">CONTRIBUTING.md</a> for more information.</p>
                </div>
                <div className="mb-10">
                  <h3 className="flex items-center mb-4 text-lg font-medium text-gray-900 dark:text-white">
                    <svg className="flex-shrink-0 mr-2 w-5 h-5 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-8-3a1 1 0 00-.867.5 1 1 0 11-1.731-1A3 3 0 0113 8a3.001 3.001 0 01-2 2.83V11a1 1 0 11-2 0v-1a1 1 0 011-1 1 1 0 100-2zm0 8a1 1 0 100-2 1 1 0 000 2z" clip-rule="evenodd"></path></svg>
                  ...
                  <p className="text-gray-500 dark:text-gray-400">Wikipedia defines a "Framework" as</p>
                  <p className="text-gray-500 dark:text-gray-400 my-2"><blockquote>a reusable set of libraries or classes for a software system or subsystem</blockquote></p>
                  <p className="text-gray-500 dark:text-gray-400">whereas an "Engine" is defined as</p>
                  <p className="text-gray-500 dark:text-gray-400 my-2"><blockquote>A software engine is a core component of a complex software system.</blockquote></p>
                  <p className="text-gray-500 dark:text-gray-400">IronERP is not just a collection of components. It's already a complex system in itself, and in fact, many users will find a base install of IronERP to already fit all of their needs as a full-featured application. On the other hand, advanced users and larger organizations will appreciate the extreme customizability and extensibility of IronERP. Therefore we believe that "Engine" is a more fitting category for IronERP than "Framework".</p>
