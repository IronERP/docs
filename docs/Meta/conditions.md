...
- __Company__ (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to IronERP.
...
- __Website__ refers to IronERP, accessible from [https://ironerp.org](https://ironerp.org)
